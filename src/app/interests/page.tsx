...
export default function Interests() {
  return (
    <>
      <ChannelHeader name="yapping" topic="music, SCP, and two open slots" />
      <div className="content-inner">
        <Reveal>
          <p style={{ fontSize: 15, color: "var(--ink-soft)", maxWidth: 640 }}>
            Two things I&apos;ll talk your ear off about unprompted. Click a card to open it. Two
            more slots reserved below — more coming whenever I write them up.
          </p>
        </Reveal>
        ...
        <div className="section-gap">
          <Reveal>
            <div className="block-head">
              <div className="block-tag">03 · 04 · reserved</div>
